...
class CSteamInterface005 : public ISteamInterface005
{
public:
	CSteamInterface005();
	virtual ~CSteamInterface005();
	...
	virtual SteamCallHandle_t RefreshAccountInfo(int arg1, TSteamError *pError){return 1;}
...
//SteamInterface004 functions
	virtual void Win32SetMiniDumpComment(const char *cszComment){return;}
	virtual void Win32SetMiniDumpSourceControlId(unsigned int uSourceControlId){return;}
	virtual void Win32SetMiniDumpEnableFullMemory(){return;}
	virtual void Win32WriteMiniDump(const char *, const char *, const char *, const char *, unsigned int){return;}
	virtual int GetCurrentAppId(unsigned int* puAppId, TSteamError *pError){return 1;}
	virtual int GetAppPurchaseCountry(unsigned int uAppId, char* szCountryCode, unsigned int uBufferLength, unsigned int* puRecievedLength, TSteamError* pError){return 1;}
//SteamInterface005 functions
	virtual int GetLocalClientVersion(unsigned int* puArg1, unsigned int* puArg2, TSteamError *pError);
	virtual int IsFileNeededByCache(unsigned int uArg1, const char* cszFileName, unsigned int uArg3, TSteamError *pError){return 1;}
	virtual int LoadFileToCache(unsigned int uArg1, const char* cszArg2, const void* pcvArg3, unsigned int uArg4, unsigned int uArg5, TSteamError *pError){return 1;}
	virtual int GetCacheDecryptionKey(unsigned int uAppId, char* szCacheDecryptionKey, unsigned int uBufferLength, unsigned int* puRecievedLength, TSteamError *pError){return 1;}
	virtual int GetSubscriptionExtendedInfo(unsigned int uSubscritptionId, const char* cszKeyName, char* szKeyValue, unsigned int uBufferLength, unsigned int* puRecievedLength, TSteamError *pError){return 1;}
	virtual int GetSubscriptionPurchaseCountry(unsigned int uSubscritptionId, char* szCountry, unsigned int uBufferLength , int* piRecievedLength, TSteamError *pError){return 1;}
	virtual int GetAppUserDefinedRecord(unsigned int uAppId, KeyValueIteratorCallback_t AddEntryToKeyValueFunc, void* pvCKeyValue, TSteamError *pError){return 1;}
};
